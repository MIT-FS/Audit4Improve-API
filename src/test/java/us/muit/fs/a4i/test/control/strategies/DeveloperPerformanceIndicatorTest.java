...
class DeveloperPerformanceIndicatorTest {
	    ...
	    public void testCalcIndicator() throws ReportItemException, NotAvailableMetricException {
	        ...
	        ReportItemI<Double> closedDevIssuesMes = new ReportItem.ReportItemBuilder<Double>("meanClosedIssuesLastMonth", 5.0).build();
	    ...
	    public void testCalcIndicatorWithMissingMetrics() throws ReportItemException, NotAvailableMetricException {
	        ...
	        ReportItemI<Double> createdIssuesMes = new ReportItem.ReportItemBuilder<Double>("createdIssuesMes", 100.0).build();
	        ReportItemI<Double> meanClosedIssuesLastMonth = new ReportItem.ReportItemBuilder<Double>("meanClosedIssuesLastMonth", 80.0).build();
